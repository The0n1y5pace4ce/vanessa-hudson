...
const guildDatas = require('../../Structures/Schemas/Counting/GuildSchema');
const userDatas = require('../../Structures/Schemas/Counting/UserSchema');
const botDatas = require('../../Structures/Schemas/Counting/BotSchema');
const userGuildDatas = require("../../Structures/Schemas/Counting/UserGuildSchema");
const { filterContent } = require("../../Structures/Utils/CountFilter");
